...
The Reason the data dosn't supports **'Simpson Paradox:'** In simpson paradox we know that in bivariate level (in simple regression) it shows positive slopes but
